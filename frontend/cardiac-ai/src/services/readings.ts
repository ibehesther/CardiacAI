...
export const saveDeviceReadings = async (deviceId: string, token: string, enable: boolean) => {
...
export const downloadDeviceReadings = async (sessionId: string, token: string) => {
